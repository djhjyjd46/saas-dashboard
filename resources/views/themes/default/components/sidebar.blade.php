...
<aside class="w-64 border-r flex-shrink-0 flex flex-col h-full overflow-y-auto custom-scrollbar"
    ...
    @if ($isAdmin)
        <nav class="mt-4 px-4 space-y-2 flex-1">
            ...
            @if (Route::has('leads'))
                <a href="{{ route('leads') }}"
                    class="{{ request()->routeIs('leads') ? $navActive : $navInactive }} block px-4 py-2 rounded-lg font-medium transition">
                    <span class="flex items-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @if (Route::has('analytics.directions'))
                <a href="{{ route('analytics.directions') }}"
                    class="{{ request()->routeIs('analytics.directions') ? $navActive : $navInactive }} block px-4 py-2 rounded-lg font-medium transition">
                    <span class="flex items-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
